...
const ResetPasswordPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-black">
      <h1 className="text-4xl font-bold text-blue-600 mb-4 text-center">Reset Password</h1>
      <p className="text-lg text-gray-600 mb-6 text-center">Enter your email to receive a password reset link.</p>

      {success ? (
        <p className="text-green-600 font-semibold">Password reset link sent! Check your email.</p>
      ) : (
