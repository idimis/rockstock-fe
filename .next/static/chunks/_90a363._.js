(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_90a363._.js", {
            ...
            const verifyEmail = {
                "VerifyEmail.useEffect.verifyEmail": async ()=>{
                    ...
                    try {
                        ...
                        const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:8080")}/api/v1/auth/verify-email?token=${token}`, {
                            method: "GET",
                            headers: {
                        ...
                        setStatus("success");
                        setTimeout({
                            "VerifyEmail.useEffect.verifyEmail": ()=>router.push(`/auth/setup-password?token=${token}`)
                        }["VerifyEmail.useEffect.verifyEmail"], 2000);
                    } catch (error) {
...
_s(VerifyEmail, "zQKJfJqFdVzVU0uuZVOqfD5CQMk=", false, function() {
    return [
...
//# sourceMappingURL=_90a363._.js.map