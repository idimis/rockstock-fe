(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_83274ffc._.js", {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useProducts.useQuery": async ()=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$axiosInstance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/products`, {
                    params: {
                        page: page - 1,
                        size: pageSize,
...
const ProductTable = ()=>{
    ...
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useProducts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProducts"])(currentPage, pageSize, searchQueryFromURL) || {
        content: [],
        totalPages: 1
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductTable.useEffect": ()=>{
            const timeout = setTimeout({
                "ProductTable.useEffect.timeout": ()=>{
                    setIsFetching(false);
                }
            }["ProductTable.useEffect.timeout"], 1000);
            if (!isLoading) {
                setIsFetching(false);
                clearTimeout(timeout);
            }
            return ({
                "ProductTable.useEffect": ()=>clearTimeout(timeout)
            })["ProductTable.useEffect"];
        }
    }["ProductTable.useEffect"], [
        isLoading
...
_s(ProductTable, "2IsYd5ZM+nooxWZIqsbTufGChM8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"],
...
//# sourceMappingURL=src_83274ffc._.js.map